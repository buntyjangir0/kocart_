...
| System Modules
|--------------------------------------------------------------------------
| Caution: Deletion of this array can lead to large authorization conflict.
| This is a general array of permissions which are used for user authorization.
| You can use an array for setting up the permissions.
| Here are a few examples:
| 'orders' =>  array('create', 'read', 'update', 'delete'),
| 'attribute' =>  array('create','update', 'delete'),
| 'attribute' =>  array('create', 'delete'),
| In above example ,
| Order is the name of module which is refered as key and the values associated with it are the permissions.
...
| Media Types
|--------------------------------------------------------------------------
| This is a general array of media types which will help to decide the format/type of document.
| You can use an array for setting up the permissions.
| Here are a few examples:
| 'image' => ['jpg', 'jpeg', 'png','gif','bmp','eps'],
| 'spreadsheet' => ['xls','xsls'],
| In above example ,
| image is the name of format type which is refered as key and the values associated with it are the extension.
