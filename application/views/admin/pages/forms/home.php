                ...
                <div class="col-md-4 col-sm-6 col-12">
                    <div class="info-box total-info-box ">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number text-white"><?= $total_earnings ?></span>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-12">
                    <div class="info-box details-box">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number text-white"><?= $admin_earnings ?></span>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-12">
                    <div class="info-box bg-secondary">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number"><?= $seller_earnings ?></span>
                        </div>
                    </div>
                </div>
